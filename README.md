# Open Government, Switzerland (open-government-switzerland)
...
## API
- **Open Government, Switzerland** — [Documentation](https://handbook.opendata.swiss/de/content/nutzen/api-nutzen.html)
